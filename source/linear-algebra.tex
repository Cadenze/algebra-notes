...
\begin{definition}
    ...
    \(\bigwedge^2 U = \{\vec{t} \in U \otimes U: \sigma(\vec{t}) = -\vec{t}\}\).
\end{definition}
\begin{proposition}\label{prop:sum-sym-wedge}
    \(U \otimes U \cong \Sym^2 U \oplus \bigwedge^2 U\).
\end{proposition}
\begin{proof}
...
\begin{proof}
    ...
    Similarly, if \(\vec{t} \in \bigwedge^2 U\), we have
    \begin{equation*}
        \sigma(\vec{t}) = -\sum_i a_i\vec{v}_i\otimes\vec{u}_i
        = \sum_i a_i\vec{u}_i\otimes\vec{v}_i = \vec{t}
    \end{equation*}
...
\begin{corollary}\label{cor:dim-sym-wedge}
    ...
    and \(\dim \bigwedge^2 U = \frac{1}{2}n(n-1)\).
\end{corollary}
\begin{proof}
    ...
    hence \(\dim \bigwedge^2 U \leq 1 + 2 + \cdots + (n-1) + n - n
    ...
    \begin{equation*}
        n^2 = \dim(U \otimes U) = \dim \Sym^2 U + \dim {\bigwedge}^2 U
...
\begin{corollary}
    ...
    and \(\{\frac{1}{2}(\vec{u}_i\otimes\vec{u}_j-\vec{u}_j\otimes\vec{u}_i)\}_{i<j} \subset \bigwedge^2 U\)
    are bases.
\end{corollary}
\begin{proof}
...
\begin{remark}
    ...
    Observe that \(\dim \bigwedge^2 \bR^3 = 3\),
...
\begin{proof}
    ...
    \begin{equation*}
        \sigma\tau(\bigotimes_{i=1}^n \vec{u}_i)
        = \sigma(\bigotimes_{i=1}^n \vec{u}_{\tau(i)})
        = \sigma(\bigotimes_{i=1}^n \vec{u}_{\sigma\tau(i)})
    \end{equation*}
\end{proof}
