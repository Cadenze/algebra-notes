...
\begin{definition}
    A morphism \(f \in \Hom(X,Y)\) is a monomorphism or monic
    if \(f \circ g = f \circ h\) implies \(g = h\) for any \(g,h\).
    A morphism \(f \in \Hom(X,Y)\) is an epimorphism or epic
    if \(g \circ f = h \circ f\) implies \(g = h\) for any \(g,h\).
\end{definition}
