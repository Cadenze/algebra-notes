...
over the 2023--2024 and 2024--2025 academic years
...
Eisenbud's \textit{Commutative Algebra}~\cite{eisenbud},
Atiyah and MacDonald's \textit{Introduction to Commutative Algebra}~\cite{atiyahmacdonald} (both for commutative algebra),
...
We have also revised the prerequisite material section based on Prof.\ Martin's MATH 437 (number theory),
as to better motivate our proofs for B\'ezout's identity and Euclid's lemma.

A small token of thanks to Justin
suggesting that the section on categories can be omitted
% as to avoid reproving tedious amounts of theorems later on.
as to reduce redundancy;
% It didn't really reduce the number of proofs,
I guess it looks nicer now?
I would also like to apologize,
because I will now finally agree that Lang is indeed
superior to Dummit \& Foote in a variety of ways.
